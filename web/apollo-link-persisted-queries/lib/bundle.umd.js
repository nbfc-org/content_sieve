(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('apollo-link'), require('hash.js'), require('graphql/language/printer')) :
	typeof define === 'function' && define.amd ? define(['exports', 'apollo-link', 'hash.js', 'graphql/language/printer'], factory) :
	(factory((global.persistedQueryLink = {}),global.apolloLink,global.hash_js,global.graphql_language_printer));
}(this, (function (exports,apolloLink,hash_js,graphql_language_printer) { 'use strict';

var VERSION = 1;
var defaultGenerateHash = function (query) {
    return hash_js.sha256()
